...
- A clear, bulleted list of what this feature _must_ accomplish.
- Example: "Sync watched state across multiple devices."

### Non-Goals

- A clear, bulleted list of what this feature _will not_ do. This is crucial for defining scope.
