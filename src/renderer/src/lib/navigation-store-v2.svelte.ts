...
export const navStoreV2 = {
    ...
    get isDetailViewActive() { return isDetailViewActive },
    init,
    navigateToFolder,
    navigateToRoot,
    openDetail,
    ...
    goBack,
    // Modals
    openSettings: () => { currentState.settingsModalOpen = true; updateUrl() },
    openItemSettings: (id: string) => { currentState.itemSettingsId = id; updateUrl() },
    closeModals: () => {
        currentState.settingsModalOpen = false;
        currentState.itemSettingsId = null;
        updateUrl()
