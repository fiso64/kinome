...
export const playerLauncherService = {
     ...
     */
    async playItem(file: MediaFile, commands: PlayerCommandConfig[] | null, preferredCommand?: PlayerCommandConfig): Promise<void> {
        ...
        const commandToExecute = preferredCommand || (commands && commands.length > 0 ? commands[0] : {
